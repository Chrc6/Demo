 ...
 */
public final class CustomSonicAudioProcessor implements AudioProcessor {
...
//  private Sonic sonic;
   ...
   */
  public CustomSonicAudioProcessor() {
    speed = 1f;
    pitch = 1f;
  ...
  @Override
  public void flush() {
    sonic = new CustomSonic(sampleRateHz, channelCount, speed, pitch, outputSampleRateHz);
    outputBuffer = EMPTY_BUFFER;
    inputBytes = 0;
    outputBytes = 0;
    inputEnded = false;
