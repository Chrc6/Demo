 ...
 * {@link com.google.android.exoplayer2.SimpleExoPlayer#setAudioAttributes(CustomAudioAttributes)} or
 ...
 * API versions.
 */
public final class CustomAudioAttributes {

  public static final CustomAudioAttributes DEFAULT = new Builder().build();

  /**
   * Builder for {@link CustomAudioAttributes}.
   */
  public static final class Builder {
    ...
    /**
     * Creates a new builder for {@link CustomAudioAttributes}.
     * <p>
    ...
    /**
     * Creates an {@link CustomAudioAttributes} instance from this builder.
     */
    public CustomAudioAttributes build() {
      return new CustomAudioAttributes(contentType, flags, usage);
    }
  ...
  private CustomAudioAttributes(@C.AudioContentType int contentType, @C.AudioFlags int flags,
  ...
  @TargetApi(21)
  /* package */ public android.media.AudioAttributes getAudioAttributesV21() {
  ...
  public boolean equals(Object obj) {
    ...
    CustomAudioAttributes other = (CustomAudioAttributes) obj;
