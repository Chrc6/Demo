...
//    private final SonicAudioProcessor sonicAudioProcessor;
    private final CustomSonicAudioProcessor sonicAudioProcessor;
    private final CustomSonicAudioProcessor2 sonicAudioProcessor2;
     ...
     *     output. May be empty.
     */
    public CustomAudioSink(@Nullable AudioCapabilities audioCapabilities,
...
//        sonicAudioProcessor = new SonicAudioProcessor();
        sonicAudioProcessor = new CustomSonicAudioProcessor();
        sonicAudioProcessor2 = new CustomSonicAudioProcessor2();
//        toIntPcmAvailableAudioProcessors = new AudioProcessor[4 + audioProcessors.length];
        ...
        toIntPcmAvailableAudioProcessors[4 + audioProcessors.length] = sonicAudioProcessor2;
...
//        this.audioProcessors = new AudioProcessor[1];
//        this.audioProcessors[0] = sonicAudioProcessor2;
    ...
    public void configure(@C.Encoding int inputEncoding, int inputChannelCount, int inputSampleRate,
        ...
        Log.i("audiosink==="," inputSampleRate="+inputSampleRate+" channelCount="+channelCount+" encoding="+inputEncoding);
        ...
        if (processingEnabled) {
            ...
            for (AudioProcessor audioProcessor : getAvailableAudioProcessors()) {
                ...
                if (audioProcessor.isActive()) {
                    ...
                    Log.i("sonic==="," configure channelCount="+channelCount+" sampleRate="+sampleRate+" encoding="+encoding);
                }
            }
        }
...
//        audioProcessors = newAudioProcessors.toArray(new AudioProcessor[count + 1]);
//        audioProcessors[audioProcessors.length - 1] = sonicAudioProcessor2;
...
//    }
    ...
    private AudioTrack createAudioTrackV21() {
        android.media.AudioAttributes attributes = null;
        if (tunneling) {
